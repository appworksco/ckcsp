...
if (isset($_POST['login'])) {
    $email = $_POST['institutional_email'];
    ...
    if (empty($invalid)) {
        $verifyEmailPassword = $usersFacade->verifyAdminEmailPassword($email, $password);
        $login = $usersFacade->loginAdmin($email, $password);
            ...
            <div>
                ...
                <div class="card card-custom">
                    <div class="card-body py-5">
                        ...
                        <div class="d-flex">
                            <a href="login-student.php" class="btn btn-outline-primary w-50 mb-3 me-1">Student</a>
                            <a href="login-faculty.php" class="btn btn-outline-primary w-50 mb-3 me-1">Faculty</a>
                            <a href="login-admin.php" class="btn btn-primary mb-3"><i class="bi bi-person"></i></a>
                        </div>
